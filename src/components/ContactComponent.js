...
class Contact extends Component {
  ...
  validate(firstName, lastName, phoneNum, email) {
    ...
    if (this.state.touched.firstName) {
      if (firstName.length < 2) {
        ...
        errors.firstName = 'First name must be at 15 or less characters.';
      }
    }
    ...
    if (this.state.touched.lastName) {
      if (lastName.length < 2) {
        ...
        errors.lastName = 'Last name must be at 15 or less characters.';
      }
    }
  ...
  render() {
    const errors = this.validate(this.state.firstName, this.state.lastName, 
                                  this.state.phoneNum, this.state.email);
    return (
