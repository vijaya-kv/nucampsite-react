...
class Contact extends Component {
  ...
  handleSubmit(values) {
    this.props.postFeedback(values.firstName,values.lastName, values.phoneNum, values.email, 
                            values.agree, values.contactType, values.feedback);
  }
          ...
          <div className="col-md-10">
            <Form model='feedbackForm' onSubmit={ values => this.handleSubmit(values)}>
              ...
              <Row className="form-group">
                ...
                <Col md={10}>
                  <Control.textarea id="feedback" name="feedback" model=".feedback"
                    rows="12"
                    className="form-control"
                   />
                </Col>
